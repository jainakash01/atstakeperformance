...
class DashboardReportApi(RequestHandler):
    ...
    def get(self,username):
        ...
        report_data = DailyTasks.query(DailyTasks.user_id == username , DailyTasks.morning_prev_done == True)
        ...
        report_eve_data = DailyTasks.query(DailyTasks.user_id == username , DailyTasks.evening_prev_done == True)
