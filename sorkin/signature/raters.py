...
class RatesInviteApi(RequestHandler):
    ...
    def put(self,username):
        ...
        existing_students.append({'name':rater_id,'status':'Pending','scopes':rater_scopes,'gapDays':submission[u'gapDays'],'gapRatings':submission[u'gapRatings'],'raterGroup':submission[u'raterGroup']})
