...
class CustomerApi(RequestHandler):
    ...
    def post(self,username):
        ...
        Thank you for your participation. You are now registered with the i@ccel Performance
        Accelerator system provided by @Stake Performance.

        Please email support@atstakeperformance.com if you have any questions.

        Thank you,

        Stephen Sorkin

        Chief Performance Officer, @Stake Performance
